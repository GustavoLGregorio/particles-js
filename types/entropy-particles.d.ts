export namespace EPTypes {
     ...
     */
    interface InitialPositionsConfig {
        targets?: Vec2[];
        spawners?: Vec2[];
    }
     ...
     */
    interface EntropyParticlesConfig {
        canvas: CanvasConfig;
